          ...
          <div className="space-y-4">
                ...
                <div
                  className={`max-w-[80%] p-3 rounded-3xl ${
                    msg.isUser
                      ...
                      : "bg-slate-700/60 text-slate-100 rounded-bl-sm border border-slate-600/50"
                  } animate-fade-in`}
                >
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="max-w-[80%] p-3 rounded-3xl bg-slate-700/60 text-slate-100 rounded-bl-sm border border-slate-600/50">
                  <div className="flex items-center space-x-2">
      ...
      >
        <div className="relative flex items-center">
          <input
            ...
            className="w-full bg-slate-700/50 border border-slate-600/50 rounded-2xl py-3 pl-4 pr-12 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/70"
          />
          <button
            type="submit"
            disabled={input.trim() === ""}
            className={`absolute right-1 rounded-xl p-2 ${
              input.trim() === ""
